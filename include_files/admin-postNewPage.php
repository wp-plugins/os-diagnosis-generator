			...
			<div class="diagnosis-contents">
				...
				<?php endif; ?>
					...
					<div class="cont diagnosis-input">
						...
						<div>
							使用できるタグは[Name]、[Text1]、[Text2]、[Text3]、[Text4]、[Text5]、[Text6]、[Text7]、[Text8]、[Text9]、[Text10]です。
						</div>
